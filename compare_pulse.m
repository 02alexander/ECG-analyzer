...
%display(ecg_data)
%[pulse, indices] = momentan_puls(ecg_data, Shimmer_9DF2_TimestampSync_Unix_CAL, 0.4, 1);
%
[pulse, indices] = pulse_time_window(ecg_data, Shimmer_9DF2_TimestampSync_Unix_CAL, 0.4, 60);
